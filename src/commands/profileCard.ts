...
export = {
    ...
    async execute(client: client, interaction: CommandInteraction) {
        ...
        interaction.reply({
            ...
            if (!user_sql) return;
            axios.get(`https://discord.com/api/guilds/${guildId}/members/${userId}`,
                {
                    headers: {
                ...
                let userAvatar: string = `https://cdn.discordapp.com/guilds/${guildId}/users/${userId}/avatars/${res.data.avatar}.webp?size=4096`  as string;
